...
a = np.array(np.random.random((num_images, 5, 2)), dtype='float32')
b = np.array(np.random.random((num_images, 5, 4)), dtype='float32')
c = np.array(np.random.random((num_images, 5, 4)), dtype='float32')
