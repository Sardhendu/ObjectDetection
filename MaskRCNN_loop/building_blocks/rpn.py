...
class RPN():
    def __init__(self, depth, feature_map):
        ...
        self.build(feature_map)
    
    def build(self, feature_map):
        shared = ops.conv_layer(feature_map, k_shape=[3, 3, feature_map.get_shape().as_list()[-1], 512],
