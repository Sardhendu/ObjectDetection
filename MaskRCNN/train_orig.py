...
class Train():
    ...
    def build_train_graph(self, batch_active_class_ids):
        ...
        mrcnn_box_loss = Loss.mrcnn_box_loss(
                mrcnn_target_box=mrcnn_target_box,
                mrcnn_pred_box=mrcnn_graph['mrcnn_bbox'],
                mrcnn_target_class_ids=mrcnn_target_class_ids,
                batch_size=self.batch_size)
        ...
        return (fpn_graph, rpn_pred_logits, rpn_pred_probs, rpn_pred_bbox, proposals,
                ...
                mrcnn_class_loss, mrcnn_box_loss, mrcnn_target_class_ids, mrcnn_target_box)
    ...
    def exec_sess(self, data_dict, image_ids):
        ...
        (fpn_graph, rpn_pred_logits, rpn_pred_probs, rpn_pred_bbox,
         ...
         mrcnn_class_loss, mrcnn_box_loss, mrcnn_target_class_ids, mrcnn_target_box_pos) = self.build_train_graph(batch_active_class_ids)
        ...
        with tf.Session() as sess:
            ...
            (rpn_pred_logits_, rpn_pred_probs_, rpn_pred_bbox_, proposals_, mrcnn_target_class_ids_,
             ...
             rpn_class_loss_, rpn_box_loss_, mrcnn_class_loss_, mrcnn_box_loss_) = sess.run([
                rpn_pred_logits,
                rpn_pred_probs,
                rpn_pred_bbox,
                proposals,
            ...
            print('mrcnn_box_loss_: ', mrcnn_box_loss_)
