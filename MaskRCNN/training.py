...
class Train():
    ...
    def build_train_graph(self):
        ...
        proposals = Proposals(self.conf, self.batch_size, rpn_class_probs, rpn_bbox,  anchors, DEBUG=True).get_proposals()
    ...
    def exec_sess(self, data_dict, image_ids):
        ...
        fpn_graph, rpn_class_logits, rpn_class_probs, rpn_bbox, proposals, mrcnn_graph, xIN, anchors = self.build_train_graph()
        ...
        with tf.Session() as sess:
            ...
            #                                 fpn_graph['fpn_p4'],
            #                                 fpn_graph['fpn_p5'],fpn_graph['fpn_p6']],
            ...
            print (rpn_class_logits_)
            print ('')
            print (rpn_bbox_)
            print('')
            print (mrcnn_class_probs_)
            print ('')
            print(mrcnn_bbox_)
            #
