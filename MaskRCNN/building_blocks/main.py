...
def inference(inference_batch_size):
    ...
    proposal_graph = obj_pl.proposals(inference_batch_size=inference_batch_size)
...
def main(pretrained_weights_path):
    ...
    with tf.Session() as sess:
        ...
        print('FPN RUN OUTPUT', p2.shape, p3.shape, p4.shape, p5.shape)
        ...
        for fpn_p in [p2, p3, p4, p5]:
            ...
            print( rpn_prob.shape, rpn_bbox.shape)
            # del rpn_logit
            del rpn_prob
            del rpn_bbox
        ...
        print('RPN RUN OUTPUT: ', rpn_probs.shape, rpn_bboxes.shape)
